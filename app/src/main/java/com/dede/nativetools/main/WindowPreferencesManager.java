...
import com.dede.nativetools.util.PreferencesKt;
...
public class WindowPreferencesManager {
    ...
    public boolean isEdgeToEdgeEnabled() {
        ...
        return getSharedPreferences()
                .getBoolean(KEY_EDGE_TO_EDGE_ENABLED, true/*VERSION.SDK_INT >= VERSION_CODES.Q*/);
    }
    ...
    private SharedPreferences getSharedPreferences() {
        return PreferencesKt.getGlobalPreferences();
    }
}
